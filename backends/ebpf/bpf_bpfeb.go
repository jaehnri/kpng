...
type bpfNodeportV4Backend struct {
	Address uint32
	Port    uint16
	_       [2]byte
}

type bpfNodeportV4Key struct{ Nodeport uint16 }
...
type bpfMapSpecs struct {
	...
	V4NodeportMap *ebpf.MapSpec `ebpf:"v4_nodeport_map"`
...
type bpfMaps struct {
	...
	V4NodeportMap *ebpf.Map `ebpf:"v4_nodeport_map"`
